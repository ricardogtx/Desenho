...
dataDrug = YAML::load_file(File.join(Rails.root,"public/static/drugs.yml"))
    ...
    campaign = Campaign.new
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/anti-drogas.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/uniad.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cad6.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/logo_obid.png"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cad2.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cartilha-sobre-o-tabaco-1-728.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/drogas-cartilha-para-pais-de-crianas-1-728.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cartilha-alcool-e-jovens-1-728.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cartilha-mudando-comportamentosweb-1-728.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/cartilha-maconha-cocainainalantes-1-728.jpg"), "r")
        ...
        drogas na escola."
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/drogas-cartilha-para-educadores-1-728.jpg"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/paisdeadolescentes.png"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/logo_ligue_1.png"), "r")
        ...
        campaign.avatar = File.open(File.join(Rails.root, "app/assets/images/campaign/vivavoz-logo.jpg"), "r")
