...
ActiveRecord::Schema.define(version: 20150617164250) do
  ...
  add_index "rolers", ["name", "resource_type", "resource_id"], name: "index_rolers_on_name_and_resource_type_and_resource_id"
  add_index "rolers", ["name"], name: "index_rolers_on_name"
  ...
  add_index "users_rolers", ["user_id", "roler_id"], name: "index_users_rolers_on_user_id_and_roler_id"
